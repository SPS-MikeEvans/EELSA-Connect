...
export function SubmitResourceForm({ onSuccess }: SubmitResourceFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
        ...
        await addDoc(collection(db, "resource_submissions"), {
            ...
            submittedByName: userDetails.fullName,
         ...
         <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Help the reviewer understand how this should be used.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
