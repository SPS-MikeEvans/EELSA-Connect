      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] border-none bg-sidebar/95 p-0 text-sidebar-foreground backdrop-blur-sm [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar/95 backdrop-blur-sm group-data-[variant=floating]:rounded-lg group-data-[variant=inset]: group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
