...
import { CalendarIcon, MapPin, User, CheckCircle, AlertTriangle } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function TrainingDetailsPage() {
  ...
  const handleJoin = async () => {
    ...
    // Optimistic check (backend rules also prevent this)
